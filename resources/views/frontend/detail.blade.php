            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                        <a href="/">
                            <img src="assets/images/logo/LOGO_RAMACCI 141x36.png" alt="Ramacci Sweaters"
                                title="Ramacci Sweaters" />
                        </a>
                    </div>
                    <!--End Desktop Logo-->
                    <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                        ...
                        <nav class="grid__item" id="AccessibleNav">
                            ...
                            <ul id="siteNav" class="site-nav medium center hidearrow">
                                <li class="lvl1 parent megamenu"><a href="/">Inicio <i
                                            class="anm anm-angle-down-l"></i></a>
                                    <ul class="dropdown">
                                        <li><a href="/nosotros" class="site-nav">Nosotros <span class=""></span> </a>
                                        </li>
                                ...
                                <li class="lvl1 parent megamenu"><a href="#">Colecciones <i
                                            class="anm anm-angle-down-l"></i></a>
                                        ...
                                        <ul class="grid mmWrapper">
                                            <li class="grid__item one-whole" style="padding-left: 0 !important">
                                                <ul class="grid text-center"
                                                    ...
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-4"><a
                                                            href="/tienda/dama" class="site-nav lvl-1">Damas</a>
                                                        <ul class="subLinks">
                                                            <li class="lvl-2"><a href="/tienda/dama/sweater"
                                                                    class="site-nav lvl-2">Sweaters</a></li>
                                                            <li class="lvl-2"><a href="/tienda/dama/twinset"
                                                                    class="site-nav lvl-2">Twim-Set</a></li>
                                                            <li class="lvl-2"><a href="/tienda"
                                                                    class="site-nav lvl-2">Talles
                                                                    Especiales</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-4"><a
                                                            href="/tienda/caballero"
                                                            class="site-nav lvl-1">Caballeros</a>
                                                        <ul class="subLinks">
                                                            <li class="lvl-2"><a href="/tienda/caballero/sweater"
                                                                    class="site-nav lvl-2">Sweaters</a></li>
                                                            <li class="lvl-2"><a href="/tienda/caballero/campera"
                                                                    class="site-nav lvl-2">Camperas</a></li>
                                                            <li class="lvl-2"><a href="/tienda/caballero/chaleco"
                                                                    class="site-nav lvl-2">Chalecos</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-4"><a
                                                        ...
                                                        <ul class="subLinks">
                                                            <li class="lvl-2"><a href="/tienda/pashmina"
                                                                    class="site-nav lvl-2">Pashminas</a></li>
                                                            <li class="lvl-2"><a href="/tienda/bufanda"
                                                                    class="site-nav lvl-2">Bufandas</a></li>
                                                            <li class="lvl-2"><a href="/tienda/pantalon"
                                                                    class="site-nav lvl-2">Pantalones</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                                ...
                                <ul class="mini-products-list">
                                    <li class="item">
                                        <a class="product-image" href="#">
                                            <img src="assets/images/product-images/cape-dress-1.jpg" alt="Prenda3"
                                                title="" />
                                        </a>
                ...
                <li class="lvl1 parent megamenu"><a href="/tienda/dama">Colecciones <i class="anm anm-plus-l"></i></a>
                    <ul>
                        <li><a href="/tienda/dama" class="site-nav">Damas<i class="anm anm-plus-l"></i></a>
                            <ul>
                                <li class="lvl-2"><a href="/tienda/dama/sweater" class="site-nav lvl-2">Sweaters</a>
                                </li>
                                <li class="lvl-2"><a href="/tienda/dama/twinset" class="site-nav lvl-2">Twim-Set</a>
                                </li>
                                            ...
                                            @foreach ($images as $image)
                                                ...
                                                <a data-image="/productoimage/{{ $image->id }}"
                                                    ...
                                                    <img class="blur-up lazyload"
                                                        src="/productoimage/{{ $image->id }}" alt="" />
                                                </a>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="product-single__meta">
                                    ...
                                    <div class="prInfoRow">
                                        ...
                                        <div class="product-sku">Código: <span
                                                class="variant-sku">{{ $product->code }}</span></div>
                                    ...
                                    <p class="product-single__price product-single__price-product-template">
                                        ...
                                        <span
                                            ...
                                            <span id="ProductPrice-product-template"><span
                                                    class="money">${{ $product->price }}.00</span></span>
                                        </span>
                                        ...
                                        <div class="product-form__item">
                                            ...
                                            <div data-value="Black" class="swatch-element color black available">
                                                <input class="swatchInput" id="swatch-0-black" type="radio"
                                                    name="option-0" value="Black"><label class="swatchLbl color large"
                                            ...
                                            <div data-value="Maroon" class="swatch-element color maroon available">
                                                <input class="swatchInput" id="swatch-0-maroon" type="radio"
                                                    name="option-0" value="Maroon"><label class="swatchLbl color large"
                                                    for="swatch-0-maroon" style="background-color:maroon;"
                                                    title="Maroon"></label>
                                            </div>
                                            <div data-value="Blue" class="swatch-element color blue available">
                                                <input class="swatchInput" id="swatch-0-blue" type="radio"
                                                    name="option-0" value="Blue"><label class="swatchLbl color large"
                                            ...
                                            <div data-value="Dark Green"
                                                ...
                                                <input class="swatchInput" id="swatch-0-dark-green" type="radio"
                                                    ...
                                                    class="swatchLbl color large" for="swatch-0-dark-green"
                                                    style="background-color:darkgreen;" title="Dark Green"></label>
                                            </div>
                                            <div data-value="Red" class="swatch-element color red available">
                                                <input class="swatchInput" id="swatch-0-red" type="radio"
                                                    name="option-0" value="Red"><label class="swatchLbl color large"
                                                    for="swatch-0-red" style="background-color:red;"
                                                    title="Rojo"></label>
                                            </div>
                                            <div data-value="Violet" class="swatch-element color violet available">
                                                <input class="swatchInput" id="swatch-0-violet" type="radio"
                                                    name="option-0" value="Violet"><label class="swatchLbl color large"
                                                    for="swatch-0-violet" style="background-color:Violet;"
                                                    title="Violeta"></label>
                                            </div>
                                            <div data-value="Orangered"
                                                class="swatch-element color orangered available">
                                                <input class="swatchInput" id="swatch-0-dark-orangered" type="radio"
                                                    name="option-0" value="Orangered"><label
                                                    class="swatchLbl color large" for="swatch-0-orangered"
                                        ...
                                        <div class="product-form__item">
                                            ...
                                            @if ($product->has_size_1 == 1)
                                                <div data-value="XS" class="swatch-element xs available">
                                                    ...
                                                    <label class="swatchLbl medium large" for="swatch-1-xs"
                                                        title="XS">XS</label>
                                                </div>
                                            @endif
                                            @if ($product->has_size_2 == 1)
                                                <div data-value="S" class="swatch-element s available">
                                                    ...
                                                    <label class="swatchLbl medium large" for="swatch-1-s"
                                                        title="S">S</label>
                                                </div>
                                            @endif
                                            @if ($product->has_size_3 == 1)
                                                <div data-value="M" class="swatch-element m available">
                                                    ...
                                                    <label class="swatchLbl medium large" for="swatch-1-m"
                                                        title="M">M</label>
                                                </div>
                                            @endif
                                            @if ($product->has_size_4 == 1)
                                                <div data-value="L" class="swatch-element l available">
                                                    ...
                                                    <label class="swatchLbl medium large" for="swatch-1-l"
                                                        title="L">L</label>
                                                </div>
                                            @endif
                                    ...
                                    <div class="display-table-cell medium-up--one-third">
                                        <div class="wishlist-btn">
                                            <a class="wishlist add-to-wishlist" href="#" title="Add to Wishlist"><i
                                                    class="icon anm anm-heart-l" aria-hidden="true"></i> <span>Añadir a
                      ...
                      <a href="#" title="Share on google+" class="btn btn--small btn--secondary btn--share">
                        <i class="fa fa-google-plus" aria-hidden="true"></i> <span class="share-title"
                          aria-hidden="true">Google+</span>
                                            ...
                                            <a target="_blank" href="/"
                                                class="btn btn--small btn--secondary btn--share share-youtube"
                                                title="YouTube">
                                                <i class="fa fa-youtube" aria-hidden="true"></i> <span
                                                    class="share-title" aria-hidden="true">YouTube</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <p id="freeShipMsg" class="freeShipMsg" data-price="199"><i class="fa fa-truck"
                                    ...
                                    Envíos dentro y fuera de Mar del Plata.<b class="freeShip"><span class="money"
                                            data-currency-usd="$199.00" data-currency="USD"></span></b>
                                    <b>Consultanos</b></p>
                                <p class="shippingMsg"><i class="fa fa-clock-o" aria-hidden="true"></i> ENTREGA ESTIMADA
                                    ENTRE <b id="fromDate">1</b> y <b id="toDate">5 días habiles</b>.</p>
                                <div class="userViewMsg" data-user="20" data-time="11000"><i class="fa fa-users"
                                        aria-hidden="true"></i>
                                    <strong class="uersView">14</strong> PERSONAS ESTÁN BUSCANDO ESTE PRODUCTO
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="prFeatures">
                        <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-sm-6 col-md-6 col-lg-3 feature">
                                    ...
                                    <div class="details">
                                        <h3>Linea Directa</h3>Hable con la línea de ayuda para su pregunta en 4141 456
                                        789, 4125 666 888
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="/detalle{{ $product->id }}">
                                            ...
                                            <img class="primary blur-up lazyload"
                                                ...
                                                src="/productoimage/{{ $product->image }}" alt="image"
                                                title="product">
                                            <!-- End image -->
                                            <!-- Hover image -->
