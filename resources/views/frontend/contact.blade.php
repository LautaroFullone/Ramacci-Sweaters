    ...
    <div id="page-content">
      ...
      <div class="page section-header text-center">
        <div class="page-title">
          <div class="wrapper">
            <h1 class="page-width">Contacto</h1>
          </div>
        </div>
      </div>
      <!--End Page Title-->
      ...
      <div class="bredcrumbWrap">
        <div class="container breadcrumbs">
          <a href="/" title="Back to the home page">Inicio</a><span
            aria-hidden="true">›</span><span>Contacto</span>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-sm-12 col-md-8 col-lg-8 mb-4">
            <h2>Escribinos</h2>
            <p>Nos pondremos en contacto contigo lo mas pronto posible.

              (Recuerda revisar tu bandeja de correo no deseado)</p>
                ...
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                      <input type="text" id="ContactFormName" name="name" placeholder="Nombre" value="" required="">
                    </div>
                  </div>
                  <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                      <input type="email" id="ContactFormEmail" name="email" placeholder="Correo Electronico" value=""
                        required="">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                      <input required="" type="tel" id="ContactFormPhone" name="phone" pattern="[0-9\-]*"
                        placeholder="Número de teléfono" value="">
                    </div>
                  </div>
                  <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                      <input required="" type="text" id="ContactSubject" name="subject" placeholder="Asunto " value="">
                    </div>
                  </div>
                </div>
                <div class="row">
          ...
          <div class="col-12 col-sm-12 col-md-4 col-lg-4">
            ...
            <ul class="addressFooter">
              <li><i class="icon anm anm-map-marker-al"></i>
                <p>Av Juan B. Justo 1335, Mar del Plata</p>
              </li>
