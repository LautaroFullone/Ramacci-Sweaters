          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
              <div class="section-header text-center">
                <h2 class="h2">Nuevos Articulos</h2>
                <p>Recorra la gran variedad de nuestros productos</p>
              </div>
              <div class="tabs-listing">
                <ul class="tabs clearfix">
                  <li class="active" rel="tab1">Damas</li>
                  <li rel="tab2">Hombres</li>
                  <li rel="tab3">Rebajas</li>
                </ul>
                <div class="tab_container">
                  <div id="tab1" class="tab_content grid-products">
                    <div class="productSlider">

                    @foreach($productsSlider1Dama as $product)
                        ...
                        <div class="product-image"
                          ...
                          <a href="/detalle{{ $product['id'] }}">
                            ...
                            <img class="primary blur-up lazyload"
                              ...
                              src="assets/images/product-images/fotosramacci2/IMG_0361.jpg"
                              alt="image"
                              title="product"
                              style="
                                display: block;
                            ...
                            <!-- End hover image -->
                            <!-- product label -->
                            <div class="product-labels rectangular"> <span class="lbl pr-label1">Nuevo</span></div>
                            <!-- End product label -->
                          </a>
                          <!-- end product image -->
                  ...
                  <div id="tab2" class="tab_content grid-products">
                    <div class="productSlider">
                    @foreach($productsSlider1Hombre as $product)
                  ...
                  <div id="tab3" class="tab_content grid-products">
                    <div class="productSlider">
                    @foreach($productsSlider1Rebaja as $product)
            ...
            <div class="collection-grid-item">
              <a href="/tienda/sweater" class="collection-grid-item__link">
                ...
                <div class="collection-grid-item__title-wrapper">
                  <h3 class="collection-grid-item__title btn btn--secondary no-border">Sweaters</h3>
                </div>
              </a>
            </div>
            <div class="collection-grid-item">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
              <div class="logo-bar">
                <div class="logo-bar__item">
                  <img src="assets/images/logo/LOGO_RAMACCI 141x36.png" alt="" title="" />
                </div>
                <div class="logo-bar__item">
                  <img src="assets/images/logo/LOGO_RAMACCI 141x36.png" alt="" title="" />
                </div>
      ...
      <div class="product-rows section">
        <div class="container">
          <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
              <div class="section-header text-center">
                <h2 class="h2">Colecciones Destacadas</h2>
                ...
                <div class="grid-view_image"
                  ...
                  <a href="/detalle{{ $product['id'] }}" class="grid-view-item__link">
                    ...
                    <img class="grid-view-item__image primary blur-up lazyload"
                      data-src="/productoimage/{{$product['image']}}"
                      src="assets/images/product-images/fotosramacci2/IMG_0331.jpg"
                      alt="image"
                      title="product"
                    >
                    <!-- End image -->
                    ...
                    <img class="grid-view-item__image hover blur-up lazyload"
                      data-src="/productoimage/{{$product['image']}}"
                      src="assets/images/product-images/fotosramacci2/IMG_0364.jpg"
                      alt="image"
                      title="product"
                    >
                    <!-- End hover image -->
                    ...
                    <div class="product-labels rectangular"> <span
                        class="lbl pr-label1">trending</span></div>
                    <!-- End product label -->
                  </a>
                  <!-- end product image -->
                  <!--start product details -->
                ...
                <div class="article__grid-meta article__grid-meta--has-image">
                  <div class="wrap-blog-inner">
                    ...
                    <div class="rte article__grid-excerpt">
                      Suéter de cachemira pura de lana nueva, jerseys para mujer, suéter de manga larga para mujer,
              ...
              <div class="wrap-blog">
                ...
                <div class="article__grid-meta article__grid-meta--has-image">
                  <div class="wrap-blog-inner">
                    ...
                    <div class="rte article__grid-excerpt">
                      Suéter de punto de invierno con cuello en V grueso de cachemir 100%
                    </div>
                    <ul class="list--inline article__meta-buttons">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
              <ul class="display-table store-info">
                <li class="display-table-cell">
                  ...
                  <h5>Envios &amp; Devoluciones Gratis</h5>
                  <span class="sub-text"> Envío gratuito en todos los pedidos de Mar del Plata</span>
                </li>
                <li class="display-table-cell">
                ...
                <li class="display-table-cell">
                  ...
                  <span class="sub-text">Atendemos tus consultas mediante WhatsApp durante el día</span>
                </li>
                <li class="display-table-cell">
                  <i class="icon anm anm-credit-card-front-r"></i>
                  <h5>Tarjetas</h5>
                  <span class="sub-text">Todos los pagos son seguros y confiables.</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="display-table splash-bg">
          ...
          <div class="display-table-cell width60 text-center">
            <div class="newsletter-left">
              ...
              <p>
                Regístrese en nuestra lista de correo electrónico exclusiva y sea el primero en conocer nuevos
                productos
              ...
              <form action="#" method="post">
                <div class="input-group">
                  <input type="email" class="input-group__field newsletter__input" name="EMAIL" value=""
                    placeholder="Correo electrónico" required="">
                  <span class="input-group__btn">
                    <button type="submit" class="btn newsletter__submit" name="commit" id="subscribeBtn"> <span
                        class="newsletter__submit-text--large">Suscribite</span> </button>
                  </span>
                </div>
              </form>
