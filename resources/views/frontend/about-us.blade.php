                	...
                	<div class="site-cart">
                        ...
                        <div id="header-cart" class="block block-cart">
                        	<ul class="mini-products-list">
                                ...
                                <li class="item">
                                	<a class="product-image" href="#">
                                    	<img src="assets/images/fotosramacci2/IMG_0343.jpg" alt="Elastic Waist Dress - Black / Small" title="" />
                                    </a>
                                    <div class="product-details">
                                    	<a href="#" class="remove"><i class="anm anm-times-l" aria-hidden="true"></i></a>
                                        <a href="#" class="edit-i remove"><i class="anm anm-edit" aria-hidden="true"></i></a>
                            ...
                            <div class="total">
                            	<div class="total-in">
                                	<span class="label">Valor Subtotal:</span><span class="product-price"><span class="money">$748.00</span></span>
                                </div>
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Nosotros</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
        ...
        <div class="container">
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                	<div class="text-center mb-4">
                        <h2 class="h2">RAMACCI Sweaters</h2>
            ...
            <div class="row">
            	<div class="col-12 col-sm-12 col-md-6 col-lg-6 mb-4">
                    ...
                    <div class="rte-setting"><p><strong>Tenemos el gran privilegio de trabajar con las más nobles lanas y transformarlas combinando nuestra trayectoria textil con amor a lo clásico y las últimas tendencias en la moda.</strong></p>
                    <p>Fieles a nuestro estilo sofisticado y contemporáneo, en Ramacci confeccionamos prendas poniendo especial atención en los detalles.</p>
                    <p></p>
                    <p>Encontrarás en nuestra marca esfuerzo y tradición haciendo sencillo el complejo proceso de vestir con elegancia y buen gusto.</p></div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <ul class="list--inline site-footer__social-icons social-icons">
                        <li><a class="social-icons__link" href="https://www.facebook.com/tejidosramacci" target="_blank" title="Ramacci Facebook"><i class="icon icon-facebook"></i></a></li>
                        ...
                        <li><a class="social-icons__link" href="https://www.instagram.com/ramaccisweaters/" target="_blank" title="Ramacci Instagram"><i class="icon icon-instagram"></i> <span class="icon__fallback-text">Instagram</span></a></li>
