    ...
    <div class="table">
      ...
      <div class="table-content">
        ...
        <div class="table-item">
          ...
          @else
            <div class="no-photo">
            <i class="fa fa-eye-slash"></i>No hay imágenes para mostrar</div>
          @endif
          ...
          <div class="table-item-field">
            <div class="actions">
              <a href="/productos/{{$product['id']}}/edit">
                <button class="action-edit" value="Editar"><i class="fa fa-edit"></i>Editar</button>
              </a>
              
              <form method="POST" action="/productos/{{$product['id']}}">
              {{ csrf_field() }}
              {{method_field('DELETE')}}
                <button class="action-delete" value="Eliminar"><i class="fa fa-trash"></i>Eliminar</button>
              </form>
            </div>
          </div>
        </div>
