...
<div class="main-container">
  <!--Sidebar Section-->
  @php include '../resources/views/backend/common/sidebar.php'; @endphp
  <!--End Sidebar Section-->
        ...
        <div class="image-container">
          <div class="main-image">
            @if(isset($images[0]))
              ...
              <a data-imageid="{{ $images[0]->id }}" class="delete-button"><i class="fa fa-trash"></i></a>
            @else
          ...
          <div class="secondary-images">
            <div class="image-2">
              @if(isset($images[1]))
                ...
                <a data-imageid="{{ $images[1]->id }}" class="delete-button"><i class="fa fa-trash"></i></a>
              @else
                <div class="image-placeholder"><i class="fa fa-image"></i></div>
              @endif
            </div>
            <div class="image-2">
              @if(isset($images[2]))
                ...
                <a data-imageid="{{ $images[2]->id }}" class="delete-button"><i class="fa fa-trash"></i></a>
              @else
                <div class="image-placeholder"><i class="fa fa-image"></i></div>
              @endif
            </div>
